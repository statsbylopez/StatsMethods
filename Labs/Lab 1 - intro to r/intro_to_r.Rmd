...
Go ahead and launch RStudio by going to [r.skidmore.edu](https://r.skidmore.edu/). You should see a window that looks like the image 
shown below.
...
As a final thought, I really liked [this tweet](https://twitter.com/dsquintana/status/904728820904845312). Learning R will not come easy, but the payoffs are, um, sweet 
