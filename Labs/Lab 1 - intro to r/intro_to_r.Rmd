...
Go ahead and launch RStudio by going to [r.skidmore.edu](r.skidmore.edu). You should see a window that looks like the image 
shown below.
...
As a final thought, I really liked this. Learning R will not come easy, but the payoffs are, um, sweet 


<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr"><a href="https://twitter.com/dsquintana/status/904728820904845312"</a></blockquote>
