...
To create your new lab report, start by opening a new R Markdown document.
...
Note that we can also get the data from google sheets. Here is the same version of the data: [https://docs.google.com/spreadsheets/d/1pRIhKItiqtDIFXxMUd52V5Xej0d4baTKUehawWevVUk/](https://docs.google.com/spreadsheets/d/1pRIhKItiqtDIFXxMUd52V5Xej0d4baTKUehawWevVUk/)

To upload this data in R, we need to use the `gsheet` package -- note, you only have to download this once, and please do not try to knit a file that is also installing a package. 

```{r}
#install.packages('gsheet')
library(gsheet)
mlb11 <- gsheet2tbl('https://docs.google.com/spreadsheets/d/1pRIhKItiqtDIFXxMUd52V5Xej0d4baTKUehawWevVUk/')
```
