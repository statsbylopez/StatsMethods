...
highlight about the relationship between these two variables? Recall: use `geom_boxplot()` to map continuous variables to boxplots. 
...
Next, we use `inference`, to conduct
